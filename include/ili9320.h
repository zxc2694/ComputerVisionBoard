...
u16 GUI_Color565(u32 RGB);  // RGB顏色轉為16位(565)

void GUI_Text(u16 x, u16 y, u8 *str, u16 len,u16 Color, u16 bkColor);
void GUI_Line(u16 x0, u16 y0, u16 x1, u16 y1,u16 color);  // 畫線
void GUI_Circle(u16 cx,u16 cy,u16 r,u16 color,u8 fill);  // 畫園
void GUI_Rectangle(u16 x0, u16 y0, u16 x1, u16 y1,u16 color,u8 fill); // 畫矩形
void GUI_Square(u16 x0, u16 y0, u16 with, u16 color,u8 fill);  // 畫正方形
